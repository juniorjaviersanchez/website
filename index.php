    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#about">Conóceme</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <p class="subtitle-a">
              "Si tu negocio no esta en internet no existe"
              <i>Bill Gates</i> 
            </p>
      ...
      <div class="row">
          ...
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <p class="s-description text-center">
                Construye una sólida presencia online con una aplicación web automatizando procesos para llegar al éxito.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <p class="s-description text-center">
                Tu sitio lucirá genial en cualquier dispositivo móvil, tablets o computadora. Yo te ayudare en el proceso.
              </p>
            </div>
          </div>
        </div>
        <!--<div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              <h2 class="s-title">Diseño Gráfico</h2>
              <p class="s-description text-center">
                Dale vida a tu imaginación para comunicar tu mensaje, nosotros lo haremos realidad Logos, Banners, y mucho más  
              </p>
            </div>
          </div>
        </div>-->
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <p class="subtitle-a">
              "Si buscas resultados distintos no hagas siempre lo mismo" <i>Albert Einstein</i> 
            </p>
            <div class="line-mf"></div>
          </div>
        </div>
          ...
          <div class="work-box">
            <a href="img/puntoflotante.png" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-12">
                    <h2 class="w-title">Punto Flotante</h2>
                    <div class="w-more">
                      <span ><a href="https://punto-flotante.herokuapp.com/html/ltr/index.php" target="_blank" class="w-ctegory">Ver Página</a></span> / <span class="w-date">2020</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="work-box">
            <a href="img/ventapollos/pollo1.png" data-lightbox="gallery-1">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-12">
                    <h2 class="w-title">S. Venta Pollos</h2>
                    <div class="w-more">
                      <span class="w-ctegory">Ver Página</span> / <span class="w-date">2020</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="work-box">
            <a href="img/work-1.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-12">
                    <h2 class="w-title">Página Projanet</h2>
                    <div class="w-more">
                      <span ><a href="https://projanettt.000webhostapp.com/" target="_blank" class="w-ctegory">Ver Página</a></span> / <span class="w-date">2020</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="work-box">
            <a href="img/work-2.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">Muni de Chiclayo</h2>
                    <div class="w-more">
                      <span ><a href="https://www.munichiclayo.gob.pe/" target="_blank" class="w-ctegory">Ver Página</a></span> / <span class="w-date">2020</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="work-box">
            <a href="img/work-3.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">Página Hidronorte srl</h2>
                    <div class="w-more">
          ...
          <div class="work-box">
            <a href="img/work-4.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">Página Panchita</h2>
                    <div class="w-more">
          ...
          <div class="work-box">
            <a href="img/work-6.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">Página Registro</h2>
                    <div class="w-more">
          ...
          <div class="work-box">
            <a href="img/work-7.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">Catálogo Piscinas</h2>
                    <div class="w-more">
                      <span ><a href="#" target="_blank"  class="w-ctegory">Ver Página</a></span> / <span class="w-date">2020</span>
                    </div>
                  </div>
            ...
            <div id="contact" class="box-shadow-full">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <a href="vidaFinanciera.php">
                      <button type="submit"  class="button btn-success button-big button-rouded" >Vida Financiera</button>
                    </a>   
                  </div>
