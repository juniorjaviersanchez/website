      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <p class="subtitle-a">
              "Estas son algunas aplicaciones que utilizo día a día, ya sea para relajarme escuchando música, ver videos, ser más productivo. Espero que les guste y claro están con todas las funcionalidades premium Gratis"
              <i></i> 
            </p>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              <h2 class="s-title">Spotify Premiun</h2>
              <p class="s-description text-center">Fuente:victorraulrr</p>
              <div align="center">
                <a href="https://victorraulrr.info/musica-y-audio/spotify-musica-y-podcasts/?download=links" target="_blank">
                  <button type="button" class="btn btn-info center-block">Características</button>
                </a>
              </div>
              <div align="center" class="p-1">
                <a href="http://www.mediafire.com/file/8f6p2yyiml869uc/Spotify%208.5.71.723%20(Mod)%20(Premium)%20@VictorRaulRR.apk/file"  target="_blank">
        ...
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <p class="s-description text-center">Fuente:ZURDOTRIX</p>
              <div align="center">
                <a href="https://www.youtube.com/watch?v=0F3eQu9robI&t=20s" target="_blank">
                  <button type="button" class="btn btn-info center-block">Características</button>
                </a>
              </div>
              <div align="center" class="p-1">
                <a href="https://www.mediafire.com/folder/xgxdz2me50ptb/Youtube"  target="_blank">
                  <button type="button" class="btn btn-success">Descargar</button>
                </a>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              <h2 class="s-title">Forest</h2>
              <p class="s-description text-center">Fuente:dlandroid</p>
              <div align="center">
                <a href="https://dlandroid.com/forest-stay-focused-apk/" target="_blank">
                  <button type="button" class="btn btn-info center-block">Características</button>
                </a>
              </div>
              <div align="center" class="p-1">
                <a href="https://drive.google.com/file/d/14TYltQZlWkqk3Ufhq1jcO-h2qXtXMRez/view"  target="_blank">
                  <button type="button" class="btn btn-success">Descargar</button>
                </a>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="service-box">
            <div class="service-ico">
              <video autoplay loop muted width="100%">
                <source src="video/sdmoaidpro.mp4"  type="video/mp4"> 
              </video>
            </div>
            <div class="service-content">
              <h2 class="s-title">SD Maid Pro</h2>
              <p class="s-description text-center">Fuente:softonic</p>
              <div align="center">
                <a href="https://sd-maid-pro-unlocker.softonic.com/android" target="_blank">
                  <button type="button" class="btn btn-info center-block">Características</button>
                </a>
              </div>
              <div align="center" class="p-1">
                <a href="https://drive.google.com/drive/folders/1xvKVfRI-nwXtbq1zIR78EbUVfIWa2sBx?usp=sharing"  target="_blank">
                  <button type="button" class="btn btn-success">Descargar</button>
                </a>
              </div>
            </div>
